...
namespace ntrex
{
  ...
  {
    if(ahrs_bool) publisher_thread_ = std::thread(&MwAhrsRosDriver::publish_topic, this);
  } 
  ...
  void MwAhrsRosDriver::covariance_calc(void)
  {
